...
function FacebookIcon() {
  return (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-label="Facebook">
...
function TwitterIcon() {
  return (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-label="Twitter / X">
...
function InstagramIcon() {
  return (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-label="Instagram">
    ...
    <header className="w-full bg-[#1f2432] font-spartan">
      ...
      <nav className="bg-white border-b border-gray-100 shadow-sm text-[18px]">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-6">
          ...
          {/* Search bar */}
          <form onSubmit={handleSearch} className="hidden md:flex items-center gap-0">
            <input
              type="text"
              value={search}
              onChange={e => setSearch(e.target.value)}
              placeholder="Search courses…"
              className="border border-gray-200 rounded-l-full px-4 py-2 w-48 focus:outline-none focus:border-[#1ab69d] focus:ring-1 focus:ring-[#1ab69d] transition"
            />
            <button
              type="submit"
              className="bg-[#1ab69d] text-white px-3 py-2 rounded-r-full hover:bg-[#159b86] transition-colors"
            >
              <SearchIcon />
            </button>
          </form>
          ...
          <Link
            href="/auth/register"
            className="flex-shrink-0 bg-[#1ab69d] hover:bg-[#159b86] text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-colors whitespace-nowrap"
          >
            Try for free →
          </Link>
        </div>
