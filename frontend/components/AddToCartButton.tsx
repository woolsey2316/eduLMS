...
export default function AddToCartButton({ addToCart, isAdded }: AddToCartButtonProps) {
  ...
  return (
    <button className="cursor-pointer bg-[#ee4a62] hover:bg-[#fff] hover:text-[#181818] text-white px-4 py-2 rounded-sm transition-colors duration-300 ease-in-out" onClick={e => handleClick(e)}>
