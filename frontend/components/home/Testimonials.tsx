    ...
    <section className="relative pt-8 pb-20 font-spartan overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5">
          <h2 className="text-4xl md:text-5xl font-semibold text-[#181818] leading-[1.1] mb-4">
            What Our Students Have To Say
          </h2>
          <img src="/underline.png" alt="" className="w-30" />
          <p className="text-[#808080] text-[15px] font-poppins leading-relaxed mb-8">
            Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor
            incididunt ut labore et dolore magna aliqua.
          </p>
          <Link
            href="/blog"
            className="group inline-flex items-center gap-2 bg-[#1ab69d] text-[18px] font-spartan text-white font-medium px-7 py-3.5 rounded-[5px] relative overflow-hidden"
          >
            <span className="relative z-10 flex items-center gap-2">View All <RightArrow/></span>
        ...
        <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {TESTIMONIALS.map((t) => (
            ...
            >
              <p className="text-[#808080] text-base leading-relaxed mb-6 flex-1">&ldquo;{t.quote}&rdquo;</p>
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#f8b81f] text-lg tracking-tight">
                  {'★'.repeat(t.rating)}
                </span>
              </div>
            </article>
