...
export default function StatsCard() {
  return (
    <section className="relative z-20 px-4 font-spartan -mb-0">
      <div className="max-w-5xl mx-auto bg-white rounded-[5px] shadow-[0px_20px_60px_0px_rgba(26,46,85,0.12)] px-6 py-10 md:px-12 md:py-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {STATS.map((stat) => (
            <div key={stat.label}>
              <p className="text-3xl md:text-4xl font-bold mb-1" style={{ color: stat.accent }}>
                {stat.value}
              </p>
